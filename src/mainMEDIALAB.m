...
fid = fopen('compLevelOutput.txt', 'w'); % open file in overwrite mode
fprintf(fid,'0'); % overwrite previous data
fclose(fid);
fid = fopen('compLevelOutput.txt', 'a'); % reopen the file in append mode
disp('solving PDE ');
...
save('resultMEDIALAB.mat','simValues','sol','time','depth');                              %saves simulation results in resultMEDIALAB matrix
